...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
	<StatCard label="Communities" value={$botStatus.communities} icon={Users} />
	<StatCard label="Active Skills" value={$botStatus.skills} icon={Zap} iconColor="text-accent-500 bg-[var(--color-accent-500-15)]" />
	<StatCard label="Users" value={$botStatus.users} icon={Activity} iconColor="text-info bg-[var(--color-info-15)]" />
</div>
